...
public class TableModeSocios extends AbstractTableModel implements TableModelListener{
	...
	private static Object[][] data = { SocioDAO.listaAMatriz(new SocioDAO().getListaSocios()) };

	
	public TableModeSocios() {
