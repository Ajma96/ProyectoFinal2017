...
public class TableModePrestamos extends AbstractTableModel implements TableModelListener{
	...
	private static Object[][] data = { PrestamoDAO.listaAMatriz(new PrestamoDAO().getListaPrestamos()) };
	
	
	public TableModePrestamos() {
